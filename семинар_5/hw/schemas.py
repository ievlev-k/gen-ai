...

    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Возвращает значения, разницу (delta) и соотношение (ratio). "
                "Используй когда вопрос про изменение/рост/падение за период."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "metric": {
                        "type": "string",
                        "description": (
                            'Одна из: "key_rate", "fx_USD", "fx_EUR", "fx_CNY", "cpi", "unemployment"'
                        ),
                    },
                    "period_a": {
                        "type": "string",
