...
ПРАВИЛА:
1. Любую арифметику (разность, отношение, процент, произведение) должен
    решать отдельный подвопрос с calculate. Никогда не рассчитывай числа
    в reasoning — делегируй Исполнителю с expected_tools=["calculate"].
